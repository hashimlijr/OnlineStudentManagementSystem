<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditStudent.aspx.cs" Inherits="OnlineStudentManagementSystem.EditStudent" %>
...
<body>
    ...
    <form id="ediyStudentForm" runat="server">
        ...
        <div>
            ...
            <label for="date">Student's date of birth*</label>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCourse.aspx.cs" Inherits="OnlineStudentManagementSystem.AddCourse" %>
...
<body>
    ...
    <form id="addCourseForm" runat="server">
        <div>
            ...
            <asp:Button ID="btn_addCourse" class="button" runat="server" Text="Add" OnClick="btn_addCourse_Click"/>
            <div class="social">

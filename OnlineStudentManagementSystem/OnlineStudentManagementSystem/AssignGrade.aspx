<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignGrade.aspx.cs" Inherits="OnlineStudentManagementSystem.AssignGrade" %>
...
<body>
    ...
    <form id="assignMarkForm" runat="server">
        <div>
            <h3>Assign Here</h3>
            <br />
            ...
            <asp:Button ID="btn_assign" class="button" runat="server" Text="Assign" OnClick="btn_assign_Click"/>
